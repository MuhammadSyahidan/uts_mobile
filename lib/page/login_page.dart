...
import 'package:uts_login/page/signup_page.dart';
import 'package:uts_login/page/splash_page.dart';
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  child: Text('register now',style: TextStyle(color: Color(0xff283618)),),
                  onTap: (){
